...
for mouseNum = 1:length(folders)
    ...
    escapeIndices = DataAll{3}{mouseNum,assayNum}(1,:); %get the behavior variable. (1=approach cricket,2=eat cricket)
...
for mouseNum = 1:length(folders)
    ...
    yBound = [.4 1];
        ...
        title('5-fold logistic regression - predict approach cricket (n=4)')
        %note significance above .5
